...
import CasibomCartItemComponent from '../components/CasibomCartItemComponent';
import CasibomComponent from '../components/CasibomComponent';
import CasibomHeader from '../components/CasibomHeader';
import {COLORS, FONTS, height, width} from '../helpers/colors';
import CartEmptyIcon from '../assets/cart_empty_icon.png';
        ...
        <>
          <View style={{height: height * 0.7}}>
            <ScrollView style={styles.flex} contentContainerStyle={styles.main}>
              {cart.map((item, index) => (
                <CasibomCartItemComponent item={item} key={index} />
              ))}
            </ScrollView>
          </View>
        </>
